  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-slate-900 dark:text-white">RiverFlow Monitor</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Real-Time Non-Contact River Monitoring System</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <Card title="Water Level History" subtitle="TF-Luna LiDAR (primary sensor)">
          <LiveChart data={waterSeries} unit="m" color="#34d399" />
        </Card>
        <Card title="Debris Detections" subtitle="Detections per frame">
